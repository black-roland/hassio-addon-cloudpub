...
В этом обновении — важные архитектурные изменения: вместо **локальной сборки контейнеров** теперь используются **контейнеры, собираемые предварительно** (pre-built containers).
...
2. Хостинг нового реестра платный, но:
   ...
   - Расходы полностью покрываются благодаря вашим донатам! Большое спасибо за поддержку! 🤗
