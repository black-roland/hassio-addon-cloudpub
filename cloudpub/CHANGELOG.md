...
- При регистрации сервисов на старте добавлены задержки: потенциально должно исправить ошибку «Канал закрыт, так как подключился новый агент» при регистрации трёх сервисов и более.
