...
- Клиент CloudPub обновлён до версии **[3.5.1056-1](https://cloudpub.ru/docs/changelog)**.
- Внесены мелкие изменения в локализацию и логирование.

## 3.4.889-1

### Изменено

- Клиент CloudPub обновлён до версии **[3.4.889-1](https://cloudpub.ru/docs/changelog)**.

## 3.3.0-2

### Добавлено

- Автоматическое обнаружение [порта, используемого Home Assistant](https://t.me/mansmarthomenews/381).
   Это изменение не затрагивает существующих пользователей, но вы можете активировать [автоопределение порта Home Assistant, изменив локальный адрес публикации](https://github.com/black-roland/hassio-addon-cloudpub/blob/master/cloudpub/DOCS.md#%D0%B0%D0%B2%D1%82%D0%BE%D0%BE%D0%BF%D1%80%D0%B5%D0%B4%D0%B5%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5-%D0%BF%D0%BE%D1%80%D1%82%D0%B0).

### Изменено

- Базовый образ (`debian-base`) обновлён до версии **9.4.0**.

## 3.3.0-1

### Исправлено

- Исправлена обработка сигнала SIGTERM при нормальной остановке аддона по кнопке «Остановить» — теперь завершение происходит корректно, без ошибок.

### Удалено

- Поддержка [устаревших 32-битных архитектур](https://t.me/mansmarthomenews/304) (`armhf`, `armv7`, `i386`).

### Изменено

- Клиент CloudPub обновлён до версии **[3.3.0](https://cloudpub.ru/docs/changelog)**.

## 3.2.2-1

### Изменено

- Клиент CloudPub обновлён до версии **[3.2.2](https://cloudpub.ru/docs/changelog)**.

## 3.1.0-1

### Изменено

- Клиент CloudPub обновлён до версии **[3.1.0](https://cloudpub.ru/docs/changelog)**.
